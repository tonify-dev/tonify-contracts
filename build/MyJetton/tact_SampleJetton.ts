...
export function loadSampleJetton$Data(slice: Slice) {
    ...
    return { $$type: 'SampleJetton$Data' as const, total_supply: _total_supply, owner: _owner, content: _content, mintable: _mintable, max_supply: _max_supply };
}
