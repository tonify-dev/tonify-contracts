...
export function storeMyJetton$Data(src: MyJetton$Data) {
    return (builder: Builder) => {
        let b_0 = builder;
...
export function loadMyJetton$Data(slice: Slice) {
    let sc_0 = slice;
    ...
    return { $$type: 'MyJetton$Data' as const, total_supply: _total_supply, owner: _owner, content: _content, mintable: _mintable, max_supply: _max_supply };
}

function loadTupleMyJetton$Data(source: TupleReader) {
    let _total_supply = source.readBigNumber();
    let _owner = source.readAddress();
    let _content = source.readCell();
    let _mintable = source.readBoolean();
...
function loadGetterTupleMyJetton$Data(source: TupleReader) {
    let _total_supply = source.readBigNumber();
    let _owner = source.readAddress();
    let _content = source.readCell();
    let _mintable = source.readBoolean();
...
function storeTupleMyJetton$Data(source: MyJetton$Data) {
    let builder = new TupleBuilder();
    builder.writeNumber(source.total_supply);
    builder.writeAddress(source.owner);
    builder.writeCell(source.content);
...
function dictValueParserMyJetton$Data(): DictionaryValue<MyJetton$Data> {
    return {
        serialize: (src, builder) => {
            builder.storeRef(beginCell().store(storeMyJetton$Data(src)).endCell());
        },
        parse: (src) => {
            return loadMyJetton$Data(src.loadRef().beginParse());
        }
    }
}

 type MyJetton_init_args = {
    $$type: 'MyJetton_init_args';
    owner: Address;
    content: Cell;
    max_supply: bigint;
...
function initMyJetton_init_args(src: MyJetton_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeRef(src.content);
...
async function MyJetton_init(owner: Address, content: Cell, max_supply: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initMyJetton_init_args({ $$type: 'MyJetton_init_args', owner, content, max_supply })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const MyJetton_errors: { [key: number]: { message: string } } = {
...
export const MyJetton_getterMapping: { [key: string]: string } = {
    'get_jetton_data': 'getGetJettonData',
    'get_wallet_address': 'getGetWalletAddress',
    'owner': 'getOwner',
}

const MyJetton_receivers: ABIReceiver[] = [
...
export class MyJetton implements Contract {
    
    static async init(owner: Address, content: Cell, max_supply: bigint) {
        return await MyJetton_init(owner, content, max_supply);
    }
    
    static async fromInit(owner: Address, content: Cell, max_supply: bigint) {
        const init = await MyJetton_init(owner, content, max_supply);
        const address = contractAddress(0, init);
        return new MyJetton(address, init);
    }
    
    static fromAddress(address: Address) {
        return new MyJetton(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  MyJetton_types,
        getters: MyJetton_getters,
        receivers: MyJetton_receivers,
        errors: MyJetton_errors,
    };
